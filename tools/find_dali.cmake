...
function(find_dali DALI_INCLUDE_DIR_VAR DALI_LIB_DIR_VAR DALI_LIBRARIES_VAR)
    ...
    execute_process(
            COMMAND Python3::Interpreter -c "import nvidia.dali as dali; print(dali.sysconfig.get_include_dir(), end='')"
    ...
    execute_process(
            COMMAND Python3::Interpreter -c "import nvidia.dali as dali; print(dali.sysconfig.get_lib_dir(), end='')"
